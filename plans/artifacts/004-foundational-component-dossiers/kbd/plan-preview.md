...
- Registry item: `shadcn/kbd`
- Origin kind: `shadcn`
- Docs URL: https://ui.shadcn.com/docs/components/kbd
- Local repo: `repos/ui`
- Pinned ref: `95471a0fb95b2b205e1850841e05d93f3fcae659`
- Source paths: `repos/ui/apps/v4/styles/base-nova/ui/kbd.tsx`
- Docs paths: `repos/ui/apps/v4/content/docs/components/base/kbd.mdx`, `repos/ui/apps/v4/content/docs/components/radix/kbd.mdx`
- Demo paths: `repos/ui/apps/v4/examples/base/kbd-button.tsx`, `repos/ui/apps/v4/examples/base/kbd-demo.tsx`, `repos/ui/apps/v4/examples/base/kbd-group.tsx`, `repos/ui/apps/v4/examples/base/kbd-input-group.tsx`, `repos/ui/apps/v4/examples/base/kbd-rtl.tsx`, `repos/ui/apps/v4/examples/base/kbd-tooltip.tsx`
- Test/spec paths: `none`
- Style variants: `repos/ui/apps/v4/styles/base-luma/ui/kbd.tsx`, `repos/ui/apps/v4/styles/base-lyra/ui/kbd.tsx`, `repos/ui/apps/v4/styles/base-maia/ui/kbd.tsx`, `repos/ui/apps/v4/styles/base-mira/ui/kbd.tsx`, `repos/ui/apps/v4/styles/base-nova/ui-rtl/kbd.tsx`, `repos/ui/apps/v4/styles/base-nova/ui/kbd.tsx`, `repos/ui/apps/v4/styles/base-rhea/ui/kbd.tsx`, `repos/ui/apps/v4/styles/base-sera/ui/kbd.tsx`, `repos/ui/apps/v4/styles/base-vega/ui/kbd.tsx`
- Runtime hints: `@/components/language-selector`, `lucide-react`, `react`
- Registry hints: `shadcn/button`, `shadcn/button-group`, `shadcn/input-group`, `shadcn/tooltip`, `utils/cn`
- Confidence: `medium`
...
1. Create these registry items as dossier-backed implementation slices: `shadcn/kbd`.
