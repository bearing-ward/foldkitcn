# shadcn/aspect-ratio Dossier Preview
...
- Registry item: `shadcn/aspect-ratio`
- Origin kind: `shadcn`
- Docs URL: https://ui.shadcn.com/docs/components/aspect-ratio
- Local repo: `repos/ui`
- Pinned ref: `95471a0fb95b2b205e1850841e05d93f3fcae659`
- Source paths: `repos/ui/apps/v4/styles/base-nova/ui/aspect-ratio.tsx`
- Docs paths: `repos/ui/apps/v4/content/docs/components/base/aspect-ratio.mdx`, `repos/ui/apps/v4/content/docs/components/radix/aspect-ratio.mdx`
- Demo paths: `repos/ui/apps/v4/examples/base/aspect-ratio-demo.tsx`, `repos/ui/apps/v4/examples/base/aspect-ratio-portrait.tsx`, `repos/ui/apps/v4/examples/base/aspect-ratio-rtl.tsx`, `repos/ui/apps/v4/examples/base/aspect-ratio-square.tsx`
- Test/spec paths: `none`
- Style variants: `repos/ui/apps/v4/styles/base-luma/ui/aspect-ratio.tsx`, `repos/ui/apps/v4/styles/base-lyra/ui/aspect-ratio.tsx`, `repos/ui/apps/v4/styles/base-maia/ui/aspect-ratio.tsx`, `repos/ui/apps/v4/styles/base-mira/ui/aspect-ratio.tsx`, `repos/ui/apps/v4/styles/base-nova/ui-rtl/aspect-ratio.tsx`, `repos/ui/apps/v4/styles/base-nova/ui/aspect-ratio.tsx`, `repos/ui/apps/v4/styles/base-rhea/ui/aspect-ratio.tsx`, `repos/ui/apps/v4/styles/base-sera/ui/aspect-ratio.tsx`, `repos/ui/apps/v4/styles/base-vega/ui/aspect-ratio.tsx`
- Runtime hints: `@/components/language-selector`, `next/image`, `react`
...
1. Create these registry items as dossier-backed implementation slices: `shadcn/aspect-ratio`.
