# shadcn/textarea Dossier Preview
...
- Registry item: `shadcn/textarea`
- Origin kind: `shadcn`
- Docs URL: https://ui.shadcn.com/docs/components/textarea
- Local repo: `repos/ui`
- Pinned ref: `95471a0fb95b2b205e1850841e05d93f3fcae659`
- Source paths: `repos/ui/apps/v4/styles/base-nova/ui/textarea.tsx`
- Docs paths: `repos/ui/apps/v4/content/docs/components/base/textarea.mdx`, `repos/ui/apps/v4/content/docs/components/radix/textarea.mdx`
- Demo paths: `repos/ui/apps/v4/examples/base/textarea-button.tsx`, `repos/ui/apps/v4/examples/base/textarea-demo.tsx`, `repos/ui/apps/v4/examples/base/textarea-disabled.tsx`, `repos/ui/apps/v4/examples/base/textarea-field.tsx`, `repos/ui/apps/v4/examples/base/textarea-invalid.tsx`, `repos/ui/apps/v4/examples/base/textarea-rtl.tsx`
- Test/spec paths: `none`
- Style variants: `repos/ui/apps/v4/styles/base-luma/ui/textarea.tsx`, `repos/ui/apps/v4/styles/base-lyra/ui/textarea.tsx`, `repos/ui/apps/v4/styles/base-maia/ui/textarea.tsx`, `repos/ui/apps/v4/styles/base-mira/ui/textarea.tsx`, `repos/ui/apps/v4/styles/base-nova/ui-rtl/textarea.tsx`, `repos/ui/apps/v4/styles/base-nova/ui/textarea.tsx`, `repos/ui/apps/v4/styles/base-rhea/ui/textarea.tsx`, `repos/ui/apps/v4/styles/base-sera/ui/textarea.tsx`, `repos/ui/apps/v4/styles/base-vega/ui/textarea.tsx`
- Runtime hints: `@/components/language-selector`, `react`
- Registry hints: `shadcn/button`, `shadcn/field`, `utils/cn`
- Confidence: `medium`
...
1. Create these registry items as dossier-backed implementation slices: `shadcn/textarea`.
