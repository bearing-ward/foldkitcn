...
- Registry item: `shadcn/sonner`
- Origin kind: `shadcn`
- Docs URL: https://ui.shadcn.com/docs/components/sonner
- Local repo: `repos/ui`
- Pinned ref: `95471a0fb95b2b205e1850841e05d93f3fcae659`
- Source paths: `repos/ui/apps/v4/styles/base-nova/ui/sonner.tsx`
- Docs paths: `repos/ui/apps/v4/content/docs/components/base/sonner.mdx`, `repos/ui/apps/v4/content/docs/components/radix/sonner.mdx`
- Demo paths: `repos/ui/apps/v4/examples/base/sonner-demo.tsx`, `repos/ui/apps/v4/examples/base/sonner-description.tsx`, `repos/ui/apps/v4/examples/base/sonner-position.tsx`, `repos/ui/apps/v4/examples/base/sonner-types.tsx`
- Test/spec paths: `none`
- Style variants: `repos/ui/apps/v4/styles/base-luma/ui/sonner.tsx`, `repos/ui/apps/v4/styles/base-lyra/ui/sonner.tsx`, `repos/ui/apps/v4/styles/base-maia/ui/sonner.tsx`, `repos/ui/apps/v4/styles/base-mira/ui/sonner.tsx`, `repos/ui/apps/v4/styles/base-nova/ui-rtl/sonner.tsx`, `repos/ui/apps/v4/styles/base-nova/ui/sonner.tsx`, `repos/ui/apps/v4/styles/base-rhea/ui/sonner.tsx`, `repos/ui/apps/v4/styles/base-sera/ui/sonner.tsx`, `repos/ui/apps/v4/styles/base-vega/ui/sonner.tsx`
- Runtime hints: `lucide-react`, `next-themes`, `sonner`
- Registry hints: `shadcn/button`
- Confidence: `medium`
...
- `next-themes`: `reject-or-defer` -> `defer` (Review before implementation; keep as fixture-only, replace locally, or defer the row.)
...
1. Create these registry items as dossier-backed implementation slices: `shadcn/sonner`.
