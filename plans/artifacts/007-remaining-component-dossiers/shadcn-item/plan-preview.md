...
- Registry item: `shadcn/item`
- Origin kind: `shadcn`
- Docs URL: https://ui.shadcn.com/docs/components/item
- Local repo: `repos/ui`
- Pinned ref: `95471a0fb95b2b205e1850841e05d93f3fcae659`
- Source paths: `repos/ui/apps/v4/styles/base-nova/ui/item.tsx`
- Docs paths: `repos/ui/apps/v4/content/docs/components/base/item.mdx`, `repos/ui/apps/v4/content/docs/components/radix/item.mdx`
- Demo paths: `repos/ui/apps/v4/examples/base/item-avatar.tsx`, `repos/ui/apps/v4/examples/base/item-demo.tsx`, `repos/ui/apps/v4/examples/base/item-dropdown.tsx`, `repos/ui/apps/v4/examples/base/item-group.tsx`, `repos/ui/apps/v4/examples/base/item-header.tsx`, `repos/ui/apps/v4/examples/base/item-icon.tsx`, `repos/ui/apps/v4/examples/base/item-image.tsx`, `repos/ui/apps/v4/examples/base/item-link.tsx`, `repos/ui/apps/v4/examples/base/item-rtl.tsx`, `repos/ui/apps/v4/examples/base/item-size.tsx`, `repos/ui/apps/v4/examples/base/item-variant.tsx`
- Test/spec paths: `none`
- Style variants: `repos/ui/apps/v4/styles/base-luma/ui/item.tsx`, `repos/ui/apps/v4/styles/base-lyra/ui/item.tsx`, `repos/ui/apps/v4/styles/base-maia/ui/item.tsx`, `repos/ui/apps/v4/styles/base-mira/ui/item.tsx`, `repos/ui/apps/v4/styles/base-nova/ui-rtl/item.tsx`, `repos/ui/apps/v4/styles/base-nova/ui/item.tsx`, `repos/ui/apps/v4/styles/base-rhea/ui/item.tsx`, `repos/ui/apps/v4/styles/base-sera/ui/item.tsx`, `repos/ui/apps/v4/styles/base-vega/ui/item.tsx`
- Runtime hints: `@/components/language-selector`, `@base-ui/react/merge-props`, `@base-ui/react/use-render`, `class-variance-authority`, `lucide-react`, `next/image`, `react`
- Registry hints: `shadcn/avatar`, `shadcn/button`, `shadcn/dropdown-menu`, `shadcn/separator`, `utils/cn`
- Confidence: `medium`
...
1. Create these registry items as dossier-backed implementation slices: `shadcn/item`.
