# shadcn/resizable Dossier Preview
...
- Registry item: `shadcn/resizable`
- Origin kind: `shadcn`
- Docs URL: https://ui.shadcn.com/docs/components/resizable
- Local repo: `repos/ui`
- Pinned ref: `95471a0fb95b2b205e1850841e05d93f3fcae659`
- Source paths: `repos/ui/apps/v4/styles/base-nova/ui/resizable.tsx`
- Docs paths: `repos/ui/apps/v4/content/docs/components/base/resizable.mdx`, `repos/ui/apps/v4/content/docs/components/radix/resizable.mdx`
- Demo paths: `repos/ui/apps/v4/examples/base/resizable-demo.tsx`, `repos/ui/apps/v4/examples/base/resizable-handle.tsx`, `repos/ui/apps/v4/examples/base/resizable-rtl.tsx`, `repos/ui/apps/v4/examples/base/resizable-vertical.tsx`
- Test/spec paths: `none`
- Style variants: `repos/ui/apps/v4/styles/base-luma/ui/resizable.tsx`, `repos/ui/apps/v4/styles/base-lyra/ui/resizable.tsx`, `repos/ui/apps/v4/styles/base-maia/ui/resizable.tsx`, `repos/ui/apps/v4/styles/base-mira/ui/resizable.tsx`, `repos/ui/apps/v4/styles/base-nova/ui-rtl/resizable.tsx`, `repos/ui/apps/v4/styles/base-nova/ui/resizable.tsx`, `repos/ui/apps/v4/styles/base-rhea/ui/resizable.tsx`, `repos/ui/apps/v4/styles/base-sera/ui/resizable.tsx`, `repos/ui/apps/v4/styles/base-vega/ui/resizable.tsx`
- Runtime hints: `@/components/language-selector`, `react`, `react-resizable-panels`
...
- `react-resizable-panels`: `reject-or-defer` -> `defer` (Review before implementation; keep as fixture-only, replace locally, or defer the row.)
...
1. Create these registry items as dossier-backed implementation slices: `shadcn/resizable`.
