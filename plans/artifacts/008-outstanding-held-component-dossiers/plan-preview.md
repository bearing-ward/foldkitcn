...
- Resolver status: `fails-missing-primary-source`
...
- Local repo: `repos/ui`
- Pinned ref: `95471a0fb95b2b205e1850841e05d93f3fcae659`
- Resolver status: `resolves-but-chart-foundation-gated`
...
- Runtime hints: `@/components/language-selector`, `@/registry/new-york-v4/ui/card`, `@/registry/new-york-v4/ui/chart`, `react`, `recharts`
