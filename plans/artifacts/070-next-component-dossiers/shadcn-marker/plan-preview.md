...
- Registry item: `shadcn/marker`
- Origin kind: `shadcn`
- Docs URL: https://ui.shadcn.com/docs/components/marker
- Local repo: `repos/ui`
- Pinned ref: `40c7064532185f5556f6cbff7dca3544987c0fe1`
- Resolution status: `source-backed`
- Source paths: `repos/ui/apps/v4/styles/base-nova/ui/marker.tsx`
- Missing primary source: `none`
- Docs paths: `repos/ui/apps/v4/content/docs/components/base/marker.mdx`, `repos/ui/apps/v4/content/docs/components/radix/marker.mdx`
- Demo paths: `repos/ui/apps/v4/examples/base/marker-border.tsx`, `repos/ui/apps/v4/examples/base/marker-demo.tsx`, `repos/ui/apps/v4/examples/base/marker-icon.tsx`, `repos/ui/apps/v4/examples/base/marker-link-button.tsx`, `repos/ui/apps/v4/examples/base/marker-separator.tsx`, `repos/ui/apps/v4/examples/base/marker-shimmer.tsx`, `repos/ui/apps/v4/examples/base/marker-status.tsx`, `repos/ui/apps/v4/examples/base/marker-variants.tsx`
- Test/spec paths: `none`
- Style variants: `repos/ui/apps/v4/styles/base-luma/ui/marker.tsx`, `repos/ui/apps/v4/styles/base-lyra/ui/marker.tsx`, `repos/ui/apps/v4/styles/base-maia/ui/marker.tsx`, `repos/ui/apps/v4/styles/base-mira/ui/marker.tsx`, `repos/ui/apps/v4/styles/base-nova/ui-rtl/marker.tsx`, `repos/ui/apps/v4/styles/base-nova/ui/marker.tsx`, `repos/ui/apps/v4/styles/base-rhea/ui/marker.tsx`, `repos/ui/apps/v4/styles/base-sera/ui/marker.tsx`, `repos/ui/apps/v4/styles/base-vega/ui/marker.tsx`
- Public registry paths: `none`
- Runtime hints: `@base-ui/react/merge-props`, `@base-ui/react/use-render`, `class-variance-authority`, `lucide-react`, `react`, `sonner`
...
1. Create these registry items as dossier-backed implementation slices: `shadcn/marker`.
