# shadcn/attachment Dossier Preview
...
- Registry item: `shadcn/attachment`
- Origin kind: `shadcn`
- Docs URL: https://ui.shadcn.com/docs/components/attachment
- Local repo: `repos/ui`
- Pinned ref: `40c7064532185f5556f6cbff7dca3544987c0fe1`
- Resolution status: `source-backed`
- Source paths: `repos/ui/apps/v4/styles/base-nova/ui/attachment.tsx`
- Missing primary source: `none`
- Docs paths: `repos/ui/apps/v4/content/docs/components/base/attachment.mdx`, `repos/ui/apps/v4/content/docs/components/radix/attachment.mdx`
- Demo paths: `repos/ui/apps/v4/examples/base/attachment-demo.tsx`, `repos/ui/apps/v4/examples/base/attachment-group.tsx`, `repos/ui/apps/v4/examples/base/attachment-image.tsx`, `repos/ui/apps/v4/examples/base/attachment-sizes.tsx`, `repos/ui/apps/v4/examples/base/attachment-states.tsx`, `repos/ui/apps/v4/examples/base/attachment-trigger.tsx`
- Test/spec paths: `none`
- Style variants: `repos/ui/apps/v4/styles/base-luma/ui/attachment.tsx`, `repos/ui/apps/v4/styles/base-lyra/ui/attachment.tsx`, `repos/ui/apps/v4/styles/base-maia/ui/attachment.tsx`, `repos/ui/apps/v4/styles/base-mira/ui/attachment.tsx`, `repos/ui/apps/v4/styles/base-nova/ui-rtl/attachment.tsx`, `repos/ui/apps/v4/styles/base-nova/ui/attachment.tsx`, `repos/ui/apps/v4/styles/base-rhea/ui/attachment.tsx`, `repos/ui/apps/v4/styles/base-sera/ui/attachment.tsx`, `repos/ui/apps/v4/styles/base-vega/ui/attachment.tsx`
- Public registry paths: `none`
- Runtime hints: `@base-ui/react/merge-props`, `@base-ui/react/use-render`, `class-variance-authority`, `lucide-react`, `react`
- Registry hints: `shadcn/button`, `shadcn/dialog`, `shadcn/spinner`, `utils/cn`
- Blockers: `none`
- Confidence: `medium`
...
1. Create these registry items as dossier-backed implementation slices: `shadcn/attachment`.
