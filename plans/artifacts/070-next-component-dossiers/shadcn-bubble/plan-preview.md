...
- Registry item: `shadcn/bubble`
- Origin kind: `shadcn`
- Docs URL: https://ui.shadcn.com/docs/components/bubble
- Local repo: `repos/ui`
- Pinned ref: `40c7064532185f5556f6cbff7dca3544987c0fe1`
- Resolution status: `source-backed`
- Source paths: `repos/ui/apps/v4/styles/base-nova/ui/bubble.tsx`
- Missing primary source: `none`
- Docs paths: `repos/ui/apps/v4/content/docs/components/base/bubble.mdx`, `repos/ui/apps/v4/content/docs/components/radix/bubble.mdx`
- Demo paths: `repos/ui/apps/v4/examples/base/bubble-alignment.tsx`, `repos/ui/apps/v4/examples/base/bubble-collapsible.tsx`, `repos/ui/apps/v4/examples/base/bubble-demo.tsx`, `repos/ui/apps/v4/examples/base/bubble-group-demo.tsx`, `repos/ui/apps/v4/examples/base/bubble-link-button.tsx`, `repos/ui/apps/v4/examples/base/bubble-markdown.tsx`, `repos/ui/apps/v4/examples/base/bubble-popover.tsx`, `repos/ui/apps/v4/examples/base/bubble-reactions.tsx`, `repos/ui/apps/v4/examples/base/bubble-tooltip.tsx`, `repos/ui/apps/v4/examples/base/bubble-variants.tsx`
- Test/spec paths: `none`
- Style variants: `repos/ui/apps/v4/styles/base-luma/ui/bubble.tsx`, `repos/ui/apps/v4/styles/base-lyra/ui/bubble.tsx`, `repos/ui/apps/v4/styles/base-maia/ui/bubble.tsx`, `repos/ui/apps/v4/styles/base-mira/ui/bubble.tsx`, `repos/ui/apps/v4/styles/base-nova/ui-rtl/bubble.tsx`, `repos/ui/apps/v4/styles/base-nova/ui/bubble.tsx`, `repos/ui/apps/v4/styles/base-rhea/ui/bubble.tsx`, `repos/ui/apps/v4/styles/base-sera/ui/bubble.tsx`, `repos/ui/apps/v4/styles/base-vega/ui/bubble.tsx`
- Public registry paths: `none`
- Runtime hints: `@/components/markdown`, `@base-ui/react/merge-props`, `@base-ui/react/use-render`, `class-variance-authority`, `lucide-react`, `react`, `sonner`
- Registry hints: `shadcn/button`, `shadcn/collapsible`, `shadcn/popover`, `shadcn/tooltip`, `utils/cn`
- Blockers: `none`
- Confidence: `medium`
...
1. Create these registry items as dossier-backed implementation slices: `shadcn/bubble`.
